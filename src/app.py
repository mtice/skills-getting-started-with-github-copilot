...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice drills and play friendly matches",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["liam@mergington.edu", "nina@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swim laps and learn competitive strokes",
    ...
    "Music Ensemble": {
        "description": "Rehearse ensemble music and perform concerts",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["sara@mergington.edu", "matt@mergington.edu"]
    },
    "Debate Team": {
        "description": "Build research and public speaking skills",
        "schedule": "Tuesdays, 3:30 PM - 5:00 PM",
        "max_participants": 12,
        "participants": ["ava@mergington.edu", "owen@mergington.edu"]
    },
    "Robotics Club": {
        "description": "Design and build robots for engineering challenges",
